...
\item \textbf{A public, reproducible pipeline.} Every stage---retrieval from the Electronic Data Gathering, Analysis, and Retrieval (EDGAR) system, parsing, scoring prompts, evaluation, and the figures in this paper---is released as runnable code against freely available sources, together with measured cost and throughput so that reuse can be budgeted rather than guessed at.
